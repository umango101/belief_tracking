...
def get_ques_start_token_idx(tokenizer: AutoTokenizer, prompt: str) -> int:
    """
...
def get_visitibility_sent_start_idx(tokenizer: AutoTokenizer, prompt: str) -> int:
    """
...
def get_prompt_token_len(tokenizer: AutoTokenizer, prompt: str) -> int:
    """
...
def check_pred(
    model: AutoModelForCausalLM, pred: str, target: str, verbose: bool = False
) -> str:
    """
