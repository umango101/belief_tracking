...
def get_answer_lookback_payload_mcqa(
    ...
    # for idx in range(n_samples):
        ...
        #     set_container=1 ^ random_choice,
        # )
        clean_prompt = "The " + object[0] + " is " + colors[answer_choice] + ". What color is the " + object[0] + "? " + symbols[0] + ". " + colors[0] + " " + symbols[1] + ". " + colors[1] + " Answer: "
        clean_ans = symbols[answer_choice]
        counterfactual_prompt = "The " + object[0] + " is " + colors[answer_choice] + ". What color is the " + object[0] + "? " + counterfactual_symbols[0] + ". " + colors[1] + " " + counterfactual_symbols[1] + ". " + colors[0] + " Answer: "
